...
public interface RenderOutputConvertor extends BaseConvertor<RenderOutput, RenderOutputDO> {

    RenderOutputConvertor INSTANCE = Mappers.getMapper(RenderOutputConvertor.class);
    ...
    RenderOutputDO to(RenderOutput entity);
    ...
    RenderOutput from(RenderOutputDO entity);
}
