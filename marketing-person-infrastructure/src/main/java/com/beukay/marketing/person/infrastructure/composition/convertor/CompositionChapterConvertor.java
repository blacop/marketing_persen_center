...
public interface CompositionChapterConvertor extends BaseConvertor<CompositionChapter, CompositionChapterDO> {

    CompositionChapterConvertor INSTANCE = Mappers.getMapper(CompositionChapterConvertor.class);

    @Override
    @Mapping(target = "tagFilter", ignore = true)
    @Mapping(target = "materialClipIds", ignore = true)
    @Mapping(target = "voiceoverIds", ignore = true)
    ...
    CompositionChapterDO to(CompositionChapter entity);
    ...
    CompositionChapter from(CompositionChapterDO entity);
}
