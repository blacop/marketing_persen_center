...
/** MaterialTag ↔ MaterialTagDO 转换 */
@Mapper(uses = BooleanStrategy.class)
public interface MaterialTagConvertor extends BaseConvertor<MaterialTag, MaterialTagDO> {

    MaterialTagConvertor INSTANCE = Mappers.getMapper(MaterialTagConvertor.class);
    ...
    MaterialTagDO to(MaterialTag entity);
    ...
    MaterialTag from(MaterialTagDO entity);
}
